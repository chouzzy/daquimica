...
export function Footer_menu() { 
   ...
   return (
      ...
      <SimpleGrid w='90vw' textAlign='center' color='datBlue' columns={5} my={3} spacingX={5} >
         ...
         <Box >
            <Image objectFit='cover' src='images/footer-menu/menu-1.png' alt='Banner inicial' />
         </Box>
         ...
         <Box >
            <Image objectFit='cover' src='images/footer-menu/menu-2.png' alt='Banner inicial' />
         </Box>
         ...
         <Box >
            <Image objectFit='cover' src='images/footer-menu/menu-3.png' alt='Banner inicial' />
         </Box>
         ...
         <Box >
            <Image objectFit='cover' src='images/footer-menu/menu-4.png' alt='Banner inicial' />
         </Box>
         ...
         <Box >
            <Image objectFit='cover' src='images/footer-menu/menu-5.png' alt='Banner inicial' />
         </Box>
      ...
      <SimpleGrid w='90vw' textAlign='center' color='datBlue' columns={2} my={3} spacingX={5} >
         <VStack
            ...
            <Box >
               <Image objectFit='cover' maxH='153px' w='100%' src='images/footer-menu/menu-4.png' alt='Banner inicial' />
            </Box>
         ...
         <Box >
            <Image objectFit='cover' maxH='153px' w='100%' src='images/footer-menu/menu-5.png' alt='Banner inicial' />
         </Box>
