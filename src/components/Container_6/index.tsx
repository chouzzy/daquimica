      ...
      <Container maxW='100vw' color='datBlue' bg='white' p='0' m='0' centerContent>
         ...
         gap={5} textAlign='center' color='datBlue'>
            <GridItem colStart={1} colEnd={13} mt='auto' py={5} borderBottom='1px solid #55808c' >
               <Image  src='images/daquimica-logo.png' maxW='50%' mx='auto' alt='Logo daquimica' />
            </GridItem>
         ...
         gap={5} textAlign='center' color='datBlue'>
            <GridItem colStart={1} colEnd={6} mt='auto' >
               ...
               <Image  src='images/daquimica-logo.png' maxW='100%' alt='Logo daquimica' />
            </GridItem>
         ...
         <>
            ...
            gap={0} textAlign='center' color='datBlue'>
               <GridItem colStart={1} colEnd={3} mt='auto' >
                  ...
                  <Image  src='images/daquimica-logo.png' maxW={['100px','100px','100px','80%']} alt='Dan Abramov' />
               </GridItem>
